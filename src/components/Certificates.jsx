                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
                    {certificateGroups.map((group, index) => (
                        ...
                        >
                            ...
                            <div className="absolute -inset-2 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-[2.5rem] blur opacity-0 group-hover:opacity-30 transition duration-700" />
                            ...
                            <div className="relative glass rounded-[2.5rem] border border-black/5 dark:border-white/10 overflow-hidden shadow-2xl overflow-hidden transition-all">
                                <div className="aspect-[16/10] relative overflow-hidden">
                                    ...
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t from-slate-200/80 dark:from-[#0f0117] dark:via-[#0f0117]/40 via-slate-100/20 to-transparent" />
                                    ...
                                    <div className="absolute bottom-10 left-10 right-10 flex justify-between items-end">
                                        <div className="space-y-2 text-left">
                                            <p className="text-purple-600 dark:text-purple-400 text-xs font-black uppercase tracking-[0.2em]">{group.issuer}</p>
                                            <h3 className="text-3xl font-black text-slate-900 dark:text-white leading-tight uppercase tracking-tighter group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                                                {group.title}
                                            </h3>
                                        </div>
                                        <div className="w-14 h-14 rounded-2xl bg-purple-500 flex items-center justify-center shadow-[0_0_30px_rgba(168,85,247,0.5)] group-hover:scale-110 transition-transform">
                                ...
                                <div className="p-8 bg-black/5 dark:bg-white/5 border-t border-black/5 dark:border-white/5">
                                    <div className="flex items-center justify-between text-sm">
                                        ...
                                        <span className="text-purple-600 dark:text-purple-400 font-black uppercase tracking-widest text-[10px]">Klik Untuk Detail</span>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
            ...
            <AnimatePresence>
                {selectedGroup && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8 bg-slate-100/95 dark:bg-[#0f0117]/98 backdrop-blur-2xl"
                    >
                        <motion.button
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
                            onClick={() => setSelectedGroup(null)}
                            className="absolute top-6 right-6 md:top-10 md:right-10 p-5 glass rounded-2xl border border-black/5 dark:border-white/10 text-slate-900 dark:text-white hover:text-purple-600 dark:hover:text-purple-400 hover:border-purple-500 hover:rotate-90 transition-all z-[110]"
                        >
                            <X className="w-8 h-8" />
                        </motion.button>
                        ...
                        <div className="relative w-full max-w-5xl flex flex-col items-center gap-8">
                            <motion.div
                                ...
                                className="w-full relative shadow-[0_0_100px_rgba(168,85,247,0.15)] rounded-[2.5rem] overflow-hidden glass border border-black/5 dark:border-white/10 group/modal"
                            >
                                <div className="flex items-center justify-center bg-black/5 dark:bg-black/20 overflow-hidden relative p-2 md:p-4">
                                    <img
                                        ...
                                        className="w-full h-auto max-h-[80vh] object-contain rounded-[2rem] shadow-2xl transition-transform duration-700 hover:scale-[1.02]"
                                    />
                                </div>
                            </motion.div>
                        </div>
